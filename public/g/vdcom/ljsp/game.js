...
function game() {
	...
	Sidebar.addMenuHeader("Game"),Sidebar.addMenuItem(Sprite.fromSheet(Sidebar.icons, 3), "Restart", function() {
		Sidebar.hide(), y()
	}), Sidebar.addMenuHeader("Setting"), Sound.setMuted(!("0" !== Store.get(R))), Sidebar.addMenuToggle(Sprite.fromSheet(Sidebar.icons, 14), "Sound", !Sound.muted, function(t) {
		Sound.setMuted(!t), Store.set(R, t ? "1" : "0")
	}), Music.setMuted(!("0" !== Store.get(A))), Sidebar.addMenuToggle(Sprite.fromSheet(Sidebar.icons, 10), "Music", !Music.muted, function(t) {
