...
! function(a) {
	var b = function(a) {
		...
		return __extends(b, a), b.prototype.init = function() {
			...
			this.load.image("rotate", "chengzhang/rotate-phone.png"), this.load.image("LoadingBar_Outer", "chengzhang/LoadingBar_Outer.png"), this.load.image("LoadingBar_Inner", "chengzhang/LoadingBar_Inner.png")
...
! function(a) {
	var b = function(b) {
		...
		return __extends(c, b), c.prototype.preload = function() {
			...
			this.game.device.webAudio && (this.load.audio("sand_block", ["chengzhang/SandTile.wav"], !0), this.load.audio("valve", ["chengzhang/valve.wav"], !0), this.load.audio("tap", ["chengzhang/TapSound.wav"], !0), this.load.audio("water", ["chengzhang/WaterSound.wav"], !0), this.load.audio("levelComplete", ["chengzhang/LevelCompleteSound.wav"], !0)), this.load.audio("main_loop", ["chengzhang/MainLoop.ogg", "chengzhang/MainLoop.m4a"], !0), this.load.atlasJSONHash("valve", "chengzhang/valve.png", "chengzhang/valve.json"), this.load.atlasJSONHash("flower", "chengzhang/flower.png", "chengzhang/flower.json"), this.load.atlasJSONHash("gnome", "chengzhang/gnome.png", "chengzhang/gnome.json"), this.load.atlasJSONHash("tutorial_hand", "chengzhang/tutorial_hand.png", "chengzhang/tutorial_hand.json"), this.load.atlasJSONHash("levelGraphics", "chengzhang/levelGraphics.png", "chengzhang/levelGraphics.json"), this.load.atlasJSONHash("gui", "chengzhang/gui.png", "chengzhang/gui.json"), this.load.image("lr_logo", "chengzhang/LR_logo.png"), a.Main.development ? this.load.json("startLevel", "chengzhang/StartLevel.json") : this.load.json("levelConfigs", "chengzhang/Levels.json")
