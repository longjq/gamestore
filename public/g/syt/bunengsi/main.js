    ...
    return {
        init: function() {
            ...
            e.run(function() {
                ...
                e.buttonLayout.released("difficulty1") ? (l.moduleName = "My Record", hideAd(), c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "噩梦模式", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "地狱模式", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "炼狱模式", c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
            }).zone(function() {
                e.canvas.fillStyle("#F00").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px Arial").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, " Seconds"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px Arial").fillStyle("#000").drawString("The Best: " + a(l.bestTime, " Seconds"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px Arial"),
            ...
            h = function() {
                ...
                if (l.time > 10000) {
                    dp_share(l.time);
                    alert("Wow!Great！You insist for " + l.time / 1000 + "seconds！")
                };
                e.buttonLayout.clear().create({
                    id: "return",
                    value: "Back",
