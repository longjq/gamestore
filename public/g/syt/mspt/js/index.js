! function(e, t) {
    e("data/jigsawGame", function(e, t, n) {
        n.exports = [{
            ...
            ka: [{
                desc: "1",
                first: "Welcome To jigsaw！",
                second: "You Pass First Level！",
                id: "1",
                pic: [{
                    img: "./images/1.gif",
                    row: 2,
                ...
                id: "2",
                first: "You are great!",
                second: "You need pay more effort!",
                pic: [{
                    img: "./images/1.gif",
                    row: 3,
                    type: 2,
        ...
        function r(e) {
            ...
            p.dom.find(".kapics").html("Level ［"+(p.currentGame.pic + 1) + "/" + n.pic.length+"］，You should finish jigsaw in "+r.second+"seconds"), u.set(f, p.currentGame), p.jigsawGame.setConfig(r)
        ...
        p.init = function(e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function(e) {
				...
				var str="Congratulation! You have passed <em>"+(p.currentGame.pic+1)+"</em> Levels";
				if(!p.hasNextPic()){
					str="Great!!!，You have passed <em>"+(p.currentGame.pic+1)+"</em>Level,Show to friends now!";
				}
				showGameResult(str,true,p.hasNextPic());
            }), p.jigsawGame.on("timeout", function() {
				showGameResult("Failure, you have only passed<em>"+(p.currentGame.pic)+"</em> Level  ",false,p.hasNextPic()); 
            })
        ...
        p.saveUserScore = function(e) {
            ...
            !e || 0 == e.ka && 0 == e.pic ? (p.dom.find(".play-info").show().find(".first-guide").html("Drag to exchange image to finish whole picture").show(), e = {
                type: c[0].type,
                ka: 0,
                pic: 0
            }) : p.dom.find(".play-info").hide().find(".first-guide").html("go!go!go!"), r(e)
        ...
        p.showNextKa = function() {
            if (!p.nextKaLayer) {
                ...
                e.delegate(".next", "click", function() {
                    ...
                    alert('Click the button and share to your friends');
                })
            }
			...
			(p.dom.find(".first-guide").html("Congratulation for mission completed!"), p.dom.find(".play-info").show().find(".playing-over").show())
			if(p.hasNextPic()){
				//p.do
			}else{
			}
            ...
            new m({
                message: "Congratulation for pass all levels",
                calcelTxt: "Close",
                sureTxt: "Play Again",
                sure: function() {
                    p.currentGame = {
        ...
        l.showPage = function(e, t) {
            ...
            if (m.curPage == m.pageIndex[0]) navigator.notification.confirm("Quit Game?", function(e) {
